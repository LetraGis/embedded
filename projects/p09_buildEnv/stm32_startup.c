...
#define SRAM_START      0x20000000UL  /* Start of SRAM */
#define SRAM_SIZE       ((1024U) + (128U))
...
/* Attribute weak and alias enables redefinition of API's. */
...
******************************************************************************/
/* Vector Table - based on the attribute, linker will place it in the
   ".isr_vector" section. */
...
******************************************************************************/
/*!****************************************************************************
 * @brief			Performs RAM initialization.
 * @details		   	Copies contents from Flash memory to RAM memory for
 *                  initialized data and initializes the rest of the memory to
 *                  zeros.
 ...
 * @details		   	Handles exceptions when the specific exception handler for
